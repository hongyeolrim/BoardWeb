...
<body>
  ...
  <form name="orderform" id="orderform" method="post" class="orderform" action="/Page">
    ...
    <div class="basketdiv" id="basket">
      ...
      <div class="row data" data-id="0" style="display: block;">
        <div class="subdiv">
          ...
          <div class="img"><img src="./images/Guatemala.jpg" width="60"></div>
          <div class="pname"> <span>과테말라안티구아(XJ-92214/1)</span> </div>
        </div>
        <div class="subdiv">
          <div class="basketprice">
            <input type="hidden" name="p_price" id="p_price0" class="p_price" value="4000">4,000원
          </div>
          <div class="num">
            <div class="updown">
      ...
      <div class="row data" data-id="1" style="display: block;">
        <div class="subdiv">
          <div class="check"><input type="checkbox" name="buy" value="260" checked="checked">&nbsp;</div>
          <div class="img"><img src="./images/Brazil.jpg" width="60"></div>
          <div class="pname"> <span>브라질산토스(XJ-92214/2)</span> </div>
        </div>
        <div class="subdiv">
          <div class="basketprice">
            <input type="hidden" name="p_price" id="p_price0" class="p_price" value="5000">5,000원
          </div>
          <div class="num">
            <div class="updown">
              <input type="text" name="p_num0" id="p_num0" size="2" maxlength="4" class="p_num" value="2"
      ...
      <div class="row data" data-id="2" style="display: block;">
        <div class="subdiv">
          <div class="check"><input type="checkbox" name="buy" value="260" checked="checked">&nbsp;</div>
          <div class="img"><img src="./images/Kenya.jpg" width="60"></div>
          <div class="pname"> <span>케냐 오크라톡신(XJ-92214/3)</span> </div>
        </div>
        <div class="subdiv">
          <div class="basketprice">
            <input type="hidden" name="p_price" id="p_price0" class="p_price" value="6000">6,000원
          </div>
          <div class="num">
            <div class="updown">
              <input type="text" name="p_num0" id="p_num0" size="2" maxlength="4" class="p_num" value="2"
      ...
      <div class="row data" data-id="3" style="display: block;">
        <div class="subdiv">
          <div class="check"><input type="checkbox" name="buy" value="260" checked="checked">&nbsp;</div>
          <div class="img"><img src="./images/Costarica.jpg" width="60"></div>
          <div class="pname"> <span>코스타리카 따라주(XJ-92214/4)</span> </div>
        </div>
        <div class="subdiv">
          <div class="basketprice">
            <input type="hidden" name="p_price" id="p_price0" class="p_price" value="6500">6,500원
          </div>
          <div class="num">
            <div class="updown">
              <input type="text" name="p_num0" id="p_num0" size="2" maxlength="4" class="p_num" value="2"
    ...
    <div class="right-align basketrowcmd">
      <a href="javascript:void(0)" class="abutton" id="btnDeleteSelected" onclick="javascript:basket.delCheckedItem();">선택상품삭제</a>
      <a href="javascript:void(0)" class="abutton" id="btnDeleteAll" onclick="javascript:basket.delAllItem();">장바구니비우기</a>
    </div>
